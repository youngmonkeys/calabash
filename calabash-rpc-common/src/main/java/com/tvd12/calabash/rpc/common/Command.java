...
public enum Command {
	...
	MESSAGE_CHANNEL_GET_ID(Commands.MESSAGE_CHANNEL_GET_ID),
	MESSAGE_CHANNEL_PUBLISH(Commands.MESSAGE_CHANNEL_PUBLISH),
	MESSAGE_CHANNEL_SUBSCRIBE(Commands.MESSSGE_CHANNEL_SUBSCRIBE);
